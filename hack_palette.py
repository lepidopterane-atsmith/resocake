'''
sarah here! I'm taking a very hacky approach to making my thing work called "correcting the colors 
IN RESO so I don't have to stare further into the tkinter abyss" so I'm doing that using a hacky ver
of palette! 

anyway back to lynn's awesome documentation...
---
pallete.py
